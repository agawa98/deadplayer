...
let queueArray = [[],[],[],[]]   // 0 - ShowID,  1 - songID,  2 - title,  3 - length
...
async function setupSongTable(){
    ...
    for(let i = 0; i<setupSongArray[0].length; i++){
        ...
        tableRow.addEventListener("click", async()=>{
            ...
            console.log(songArray[0][tempSongID])
...
function queuePositioner(){
    ...
    console.log(controlDivHeight)
    document.getElementById("songTable").style.bottom = controlDivHeight + "px"
}
