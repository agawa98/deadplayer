...
async function setupShowTable(res, date){  // res to response z archiva. date data w rrrr-mm-dd
    ...
    for(let i=0; i<sortedArray.length; i++){
        ...
        tableRow.addEventListener("click",(el)=>{
            ...
            showID = el.target.parentNode.getElementsByClassName("IDCell")[0].textContent                   // Default player VVVV z archive org
            ...
            console.log(document.getElementsByClassName("tableRowActive"))
...
async function setupSongTable(){
    ...
    for(let i = 0; i<songArray[0].length; i++){
        ...
        songName.textContent = songArray[1][i]

        

        tableRow.addEventListener("click", ()=>{
            startSong(songArray[0][tableRow.querySelector("#songTableOrder").textContent-1], tableRow.querySelector("#songTableOrder").textContent-1)
        })
        ...
        songLength.textContent = songArray[2][i]

        let songID = document.createElement("td")
        songID.id = "songTableID"
        songID.textContent = songArray[0][i]

        tableRow.append(songOrder, songName, songLength, songID)
...
document.getElementById("prevButton").addEventListener("click", ()=>{
    if(currentSong.currentTime<5 && currentSongID!=0){
        ...
        startSong(songArray[0][currentSongID-1], currentSongID-1)
...
function preloadNextSong(){
    preloadSong.src = "https://archive.org/download/"+showID+"/"+songArray[0][currentSongID+1]
    preloadSong.load()
    
    console.log("preloaded: " + "https://archive.org/download/"+showID+"/"+songArray[0][currentSongID+1])
}
